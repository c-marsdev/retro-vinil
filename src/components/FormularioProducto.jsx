...
const FormularioProducto = (productoSeleccionado, o) => {
  const navigate = useNavigate();
  const { productos, agregarProducto, editarProducto } = useProductosContext();
  ...
  useEffect(() => {
    if (modo === "editar" && productoSeleccionado) {
      setProducto({
        ...
        conticionFunda: productoSeleccionado.condicionFunda || "",
